...
CREATE OR REPLACE FUNCTION "public"."get_post_meta_by_token"("p_post_id" "uuid", "p_token" "text") RETURNS TABLE("id" "uuid", "title" "text", "body_md" "text", "cover_image_url" "text", "visibility" "text", "author_display_name" "text", "author_username" "text")
  ...
  left join public.profiles prof
    on prof.user_id = p.author_id
  where p.id = p_post_id
    and p.is_published = true
    and p.visibility = 'link' -- リンク限定想定
    and p.link_token = p_token
  limit 1;
$$;


ALTER FUNCTION "public"."get_post_meta_by_token"("p_post_id" "uuid", "p_token" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_public_post_meta"("p_post_id" "uuid") RETURNS TABLE("id" "uuid", "title" "text", "body_md" "text", "cover_image_url" "text", "visibility" "text", "author_display_name" "text", "author_username" "text")
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select
...
ALTER FUNCTION "public"."get_public_post_meta"("p_post_id" "uuid") OWNER TO "postgres";
...
CREATE POLICY "profiles_update_self_notifications" ON "public"."profiles" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
GRANT ALL ON FUNCTION "public"."get_post_meta_by_token"("p_post_id" "uuid", "p_token" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_post_meta_by_token"("p_post_id" "uuid", "p_token" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_post_meta_by_token"("p_post_id" "uuid", "p_token" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_public_post_meta"("p_post_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_public_post_meta"("p_post_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_public_post_meta"("p_post_id" "uuid") TO "service_role";
